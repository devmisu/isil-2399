...
routes.post('/', (req, res) => {
    ...
    const { result, devMessage } = util.sanitize(req.body, ['id_member', 'id_requirement', 'estimate_start_date', 'estimate_end_date', 'estimate_hours', 'real_start_date', 'real_end_date', 'real_hours', 'comment', 'state'])
    ...
    const params = [
        ...
        req.body['real_start_date'],
        req.body['real_end_date'],
        req.body['real_hours'],
        req.body['comment'],
        req.body['state']
    ]
...
routes.put('/member/:id_member/requirement/:id_requirement', (req, res) => {
    ...
    const { result, devMessage } = util.sanitize(req.body, ['estimate_start_date', 'estimate_end_date', 'estimate_hours', 'real_start_date', 'real_end_date', 'real_hours', 'comment', 'state'])
